//! ```text
//! Autogenerated: word_by_word_montgomery --lang Rust --inline -o 'fieldp256/ops.rs' p256 64 '2^256 - 2^224 + 2^192 + 2^96 - 1' to_montgomery from_montgomery to_bytes from_bytes add sub opp mul square selectznz
...
/// ```
#[inline]
pub const fn fiat_p256_addcarryx_u64(out1: &mut u64, out2: &mut fiat_p256_u1, arg1: fiat_p256_u1, arg2: u64, arg3: u64) {
...
/// ```
#[inline]
pub const fn fiat_p256_subborrowx_u64(out1: &mut u64, out2: &mut fiat_p256_u1, arg1: fiat_p256_u1, arg2: u64, arg3: u64) {
...
///
#[inline]
pub const fn fiat_p256_to_montgomery(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_non_montgomery_domain_field_element) {
...
///
#[inline]
pub const fn fiat_p256_from_montgomery(mut out1: &mut fiat_p256_non_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element) {
...
///
#[inline]
pub const fn fiat_p256_add(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element, arg2: &fiat_p256_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x1, &mut x2, 0x0, (*IndexConst(arg1).index(0)), (*IndexConst(arg2).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x3, &mut x4, x2, (*IndexConst(arg1).index(1)), (*IndexConst(arg2).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(2)), (*IndexConst(arg2).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x7, &mut x8, x6, (*IndexConst(arg1).index(3)), (*IndexConst(arg2).index(3)));
  let mut x9: u64 = 0;
...
///
#[inline]
pub const fn fiat_p256_sub(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element, arg2: &fiat_p256_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x1, &mut x2, 0x0, (*IndexConst(arg1).index(0)), (*IndexConst(arg2).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x3, &mut x4, x2, (*IndexConst(arg1).index(1)), (*IndexConst(arg2).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(2)), (*IndexConst(arg2).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x7, &mut x8, x6, (*IndexConst(arg1).index(3)), (*IndexConst(arg2).index(3)));
  let mut x9: u64 = 0;
...
///
#[inline]
pub const fn fiat_p256_opp(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x1, &mut x2, 0x0, (0x0 as u64), (*IndexConst(arg1).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x3, &mut x4, x2, (0x0 as u64), (*IndexConst(arg1).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x5, &mut x6, x4, (0x0 as u64), (*IndexConst(arg1).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x7, &mut x8, x6, (0x0 as u64), (*IndexConst(arg1).index(3)));
  let mut x9: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x9, x8, (0x0 as u64), 0xffffffffffffffff);
  let mut x10: u64 = 0;
  let mut x11: fiat_p256_u1 = 0;
...
///
#[inline]
pub const fn fiat_p256_mul(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element, arg2: &fiat_p256_montgomery_domain_field_element) {
  let x1: u64 = (*IndexConst(arg1).index(1));
  let x2: u64 = (*IndexConst(arg1).index(2));
  let x3: u64 = (*IndexConst(arg1).index(3));
  let x4: u64 = (*IndexConst(arg1).index(0));
...
///
#[inline]
pub const fn fiat_p256_square(mut out1: &mut fiat_p256_montgomery_domain_field_element, arg1: &fiat_p256_montgomery_domain_field_element) {
  let x1: u64 = (*IndexConst(arg1).index(1));
  let x2: u64 = (*IndexConst(arg1).index(2));
  let x3: u64 = (*IndexConst(arg1).index(3));
  let x4: u64 = (*IndexConst(arg1).index(0));
...
/// ```
#[inline]
pub const fn fiat_p256_selectznz(mut out1: &mut [u64; 4], arg1: fiat_p256_u1, arg2: &[u64; 4], arg3: &[u64; 4]) {
  let mut x1: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x1, arg1, (*IndexConst(arg2).index(0)), (*IndexConst(arg3).index(0)));
  let mut x2: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x2, arg1, (*IndexConst(arg2).index(1)), (*IndexConst(arg3).index(1)));
  let mut x3: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x3, arg1, (*IndexConst(arg2).index(2)), (*IndexConst(arg3).index(2)));
  let mut x4: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x4, arg1, (*IndexConst(arg2).index(3)), (*IndexConst(arg3).index(3)));
